package shadowmaster435.noxiouslands.dimension.chunkbuilder;
...
public class NoxiousLandsChunkBuilder extends ChunkGenerator {
    // Just an example of adding a custom boolean
    protected final boolean customBool;

    public static final Codec<NoxiousLandsChunkBuilder> CODEC = RecordCodecBuilder.create((instance) ->
            instance.group(
                    ...
                    .apply(instance, instance.stable(NoxiousLandsChunkBuilder::new))
    );

    public NoxiousLandsChunkBuilder(BiomeSource biomeSource, boolean customBool) {
